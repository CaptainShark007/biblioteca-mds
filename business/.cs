    ...
    public class PatternDemoRunner
    {
        public static async Task Main(string[] args)
        {
            ...
            while (continuar)
            {
                ...
                {
                    case "1":
                        ObserverPatternExample.DemostrarPatronObserver();
                        break;

                    case "2":
                        await AdapterPatternExample.DemostrarPatronAdapter();
                        break;

                    case "3":
                        ObserverPatternExample.EjemploIntegracionConServicio();
                        break;

                    case "4":
                        AdapterPatternExample.EjemploConfiguracion();
                        break;
        ...
        private static void MostrarMenu()
        {
            ...
            Console.WriteLine("  [1] Demostrar Patron OBSERVER");
            Console.WriteLine("      ? Sistema de notificaciones y eventos");
            Console.WriteLine();

            Console.WriteLine("  [2] Demostrar Patron ADAPTER");
            Console.WriteLine("      ? Integracion con sistemas de pago externos");
            Console.WriteLine();

            Console.WriteLine("  [3] Ejemplo de Integracion Observer");
            Console.WriteLine("      ? Como usar Observer en un servicio");
            Console.WriteLine();

            Console.WriteLine("  [4] Ejemplo de Configuracion Adapter");
            Console.WriteLine("      ? Como configurar Adapter en Program.cs");
            Console.WriteLine();

            Console.WriteLine("  [5] Ver Resumen de Todos los Patrones");
            Console.WriteLine();

            Console.WriteLine("  [6] Ver Beneficios de los Patrones");
            Console.WriteLine();
        ...
        private static void MostrarResumenPatrones()
        {
            ...
            var patrones = new[]
            {
                ("1. REPOSITORY", "Abstraccion del acceso a datos", "Creacional"),
                ...
                ("9. ADAPTER", "Compatibilidad entre interfaces", "Estructural")
            };
